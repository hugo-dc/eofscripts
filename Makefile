all: build install
build: build-idcost build-returnevm build-returneofdata build-deploy build-call build-eof_gen build-yulreturn build-gentruncpush build-createaddress build-createaddress2 build-mnem2evm build-evm2mnem
build-idcost:
